...
<div>
    <select v-model="selectedItem">
      <option  v-for="casino in casinos" 
      :key="casino.id" :value="casino.id">
        {{ casino.name}}, {{ casino.city }}, {{ casino.cstate }} 
      </option>
    </select>
  </div>
    ...
    <div class="bg-slate-50 min-h-screen p-8">
      ...
      <h1 class="text-2xl  mb-4">Here is a list of all casinos in the US. .</h1>
